...
```
User: matt.m.kissinger@gmail.com
...
```jsonl
{"type":"system","subtype":"init","apiKeySource":"login","cwd":"/home/mkagent/mycelium-v2","session_id":"...","model":"Gemini 3 Flash","permissionMode":"default"}
...
~/.cursor/projects/
  ...
  home-mkagent-repos-pixel-forge/
  ...
```
...
- [x] `agent status` shows logged in as `matt.m.kissinger@gmail.com`
