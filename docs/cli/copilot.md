...
```bash
cd /tmp && GITHUB_TOKEN="" copilot -p "read /home/dev/mycelium-v2/package.json and tell me the name field" \
...
- `/home/dev/mycelium-v2/AGENTS.md` - does not exist
- `/home/dev/mycelium-v2/.github/copilot-instructions.md` - does not exist
- `/home/dev/mycelium-v2/.copilot/` - does not exist
