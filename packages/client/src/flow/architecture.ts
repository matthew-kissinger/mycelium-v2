/**
 * System architecture - two column layout
 *
 * Left column (main flow):        Right column:
 *
 *    [Scheduler]                   [Repos]
 *         │                          │
 *    [Discovery] ◄───────────────────┤
...
// =============================================================================
// Two-column layout: main flow left, memory right
// Left column X=150, Right column X=500
// =============================================================================
...
export const SYSTEM_EDGES: Edge[] = [
  // Scheduler -> Discovery (straight down)
  {
  ...
  // Repos -> Discovery (repos are scanned by discovery)
  {
  ...
  // Discovery -> Task Pool (straight down)
  {
  ...
  // Task Pool -> Dispatcher (straight down)
  {
  ...
  // Dispatcher -> Agent Slots (straight down)
  {
  ...
  // Agent Slots -> Shepherd (straight down)
  {
  ...
  // Shepherd -> Memory (right to Memory on the right side)
  {
  ...
  // Memory -> Discovery (feedback loop - back up to Discovery)
  {
